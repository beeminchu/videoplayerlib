...
#endif
typedef void functioncallback(unsigned char* buffer,int datasize,int videowidth,int videoheight, int pts);
...
public:
  ...
  static FileSink* createNew(UsageEnvironment& env, functioncallback function_callback,
                             unsigned bufferSize = 20000,
                             Boolean oneFilePerFrame = False);
  // "bufferSize" should be at least as large as the largest expected
  //   input frame.
